...
describe('Clase carritoCompra', () => {
    ...
    describe('Sobre el constructor de la clase', () => {
        ...
        it('carritoComnpra deberia ser una instancia de la clase CarritoCompra', () => {
    ...
    describe('metodos de la clase', () => {
        ...
        it('El metodo aplicarDescuento deberia aplicar el descuento', () => {
            ...
            const subTotal = producto1.precio * producto1.Cantidad + producto2.precio * producto2.Cantidad + producto3.precio * producto3.Cantidad;
            const descuento = 10;
